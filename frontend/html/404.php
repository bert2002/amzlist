...
if ($language) {
        ...
        include('../lang/en.php');
        $language = "en";
        header("Location: http://$IS_DOMAIN/404/$language/",TRUE,301);
}
...
<div class="maintop">
 <div class="center">
  ...
  <div style="float:right; margin-top: 70px;">
  	<a href="/404/en/"><button class="button" >EN</button></a>
  	<a href="/404/de/"><button class="button" >DE</button></a>
  </div>
 </div> <!-- center end -->  
</div> <!-- maintop end -->
...
<div id="load" style="display:none;"><br><br><br><b><?php echo $LANG['loading']['title'];?><b><br><img src="/img/loading.gif"/><br><?php echo $LANG['loading']['text'];?><br></div>
    ...
    <?php
      $texterrortitle = $LANG['error']['title'];
      $texterrortext = $LANG['error']['text'];
    ?>

    <div style="height: 5px;"></div>
      <div class="headline"><?php echo $texterrortitle; ?> 404</div>
