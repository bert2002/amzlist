...
if ($language) {
        ...
        include('../lang/en.php');
        $language = "en";
        header("Location: http://$IS_DOMAIN/legal/$language/",TRUE,301);
}
...
<div class="maintop">
 <div class="center">
  ...
  <div style="float:right; margin-top: 70px;">
  	<a href="/legal/en/"><button class="button" >EN</button></a>
  	<a href="/legal/de/"><button class="button" >DE</button></a>
  </div>
 </div> <!-- center end -->  
</div> <!-- maintop end -->
...
<div id="load" style="display:none;"><br><br><br><b><?php echo $LANG['loading']['title'];?><b><br><img src="/img/loading.gif"/><br><?php echo $LANG['loading']['text'];?><br></div>
    ...
    <div class="headline"><?php echo $LANG['legal']['title'];?></div>
    <div class="text"><?php echo $LANG['legal']['text'];?></div>
