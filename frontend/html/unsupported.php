...
<div class="maintop">
 <div class="center">
  ...
  <div style="float:right; margin-top: 70px;">
  	<a href="/unsupported/en/"><button class="button" >EN</button></a>
  	<a href="/unsupported/de/"><button class="button" >DE</button></a>
  </div>
 </div> <!-- center end -->  
</div> <!-- maintop end -->
  ...
  <div class="center">    
    ...
    <?php
      $texterrortitle = $LANG['unsupported']['title'];
      $texterrortext = $LANG['unsupported']['text'];
    ?>
