...
<div class="maintop">
 <div class="center">
  ...
  <div style="float:right; margin-top: 70px;">
  	<a href="/aboutus/en/"><button class="button" >EN</button></a>
  	<a href="/aboutus/de/"><button class="button" >DE</button></a>
  </div>
 </div> <!-- center end -->  
</div> <!-- maintop end -->
...
<div id="load" style="display:none;"><br><br><br><b><?php echo $LANG['loading']['title'];?><b><br><img src="/img/loading.gif"/><br><?php echo $LANG['loading']['text'];?><br></div>
    ...
    <div style="height: 5px;"></div>
      <div class="headline"><?php echo $LANG['aboutus']['title']; ?></div>
      <div class="text"><?php echo $LANG['aboutus']['text']; ?></div>
    <div class="headline"><?php echo $LANG['aboutus']['email']['title'];?></div>
    <div class="text"><?php echo $LANG['aboutus']['email']['text'];?><img src="/img/contact.png"/></div>
      <div class="headline"><?php echo $LANG['aboutus']['currencyrate']['title']; ?></div>
      <div class="text"><?php echo $LANG['aboutus']['currencyrate']['text']; ?></div>
